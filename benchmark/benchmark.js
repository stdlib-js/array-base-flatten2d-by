...
bench( format( '%s:size=100,lexicographic', pkg ), function benchmark( b ) {
	var x;
	var i;
	var v;
...
bench( format( '%s:size=100,colexicographic', pkg ), function benchmark( b ) {
	var x;
	var i;
	var v;
...
bench( format( '%s:assign:size=100,lexicographic', pkg ), function benchmark( b ) {
	var out;
	var x;
	var i;
	var v;
...
bench( format( '%s:assign:size=100,colexicographic', pkg ), function benchmark( b ) {
	var out;
	var x;
	var i;
	var v;
